        	...
        	<div id="ms">
             	<div id="lf" style="float:left;">
                    ...
                    <!--主選單放此-->
                    			...
                    			最新消息資料管理                    			</div>
							                            ...
							                            <a style="color:#000; font-size:13px; text-decoration:none;" href="?do=admin&redo=member">
                            	<div class="mainmu">
                    			管理者帳號管理                    			</div>
                            </a>
                ...
                <div class="di" style="height:540px; border:#999 1px solid; width:76.5%; margin:2px 0px 0px 0px; float:left; position:relative; left:20px;">
                	                     <!--正中央-->
                                                    <table width="100%">
                                	<tbody><tr>
                                    	<td style="width:70%;font-weight:800; border:#333 1px solid; border-radius:3px;" class="cent"><a href="?do=admin" style="color:#000; text-decoration:none;">後台管理區</a></td><td><button onclick="document.location.href='index.php'" style="width:99%; margin-right:2px; height:50px;">管理登出</button></td>
                                    </tr>
                                </tbody></table>
